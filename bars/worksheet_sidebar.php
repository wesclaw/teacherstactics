        ...
        <div class="accordion" id="accordionExample">
          ...
          <div class="accordion-item">
            ...
            <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
              <li>
                  <label for="com_club" name='li'>Name Writing</label>
                  <input type="checkbox" name='li' id='com_club' class='checkbox'>
                </li>
              <li>
                  <label for="guitar" name='li'>Letter Formation</label>
                  <input type="checkbox" name='li' id='guitar' class='checkbox'>
                </li>
              <li>
                  <label for="piano" name='li'>Writing Simple Words</label>
                  <input type="checkbox" name='li' id='piano' class='checkbox'>
                </li>
          ...
          <div class="accordion-item">
            ...
            <div id="collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
              <li>
                  <label for="com_club" name='li'>Comparing Sizes (big/small)</label>
                  <input type="checkbox" name='li' id='com_club' class='checkbox'>
                </li>
              <li>
                  <label for="guitar" name='li'>Measuring Lengths</label>
                  <input type="checkbox" name='li' id='guitar' class='checkbox'>
                </li>
              <li>
                  <label for="piano" name='li'>Identifying Shapes</label>
                  <input type="checkbox" name='li' id='piano' class='checkbox'>
                </li>
          ...
          <div class="accordion-item">
            ...
            <div id="collapseSeven" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
              <li>
                  <label for="com_club" name='li'>Community Helpers</label>
                  <input type="checkbox" name='li' id='com_club' class='checkbox'>
                </li>
              <li>
                  <label for="guitar" name='li'>Seasons and Weather</label>
                  <input type="checkbox" name='li' id='guitar' class='checkbox'>
                </li>
              <li>
                  <label for="piano" name='li'>Animals and Habitats</label>
                  <input type="checkbox" name='li' id='piano' class='checkbox'>
                </li>
          ...
          <div class="accordion-item">
            ...
            <div id="collapseEight" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
              <li>
                  <label for="com_club" name='li'>Coloring Pages</label>
                  <input type="checkbox" name='li' id='com_club' class='checkbox'>
                </li>
              <li>
                  <label for="guitar" name='li'>Drawing Prompts</label>
                  <input type="checkbox" name='li' id='guitar' class='checkbox'>
                </li>
              <li>
                  <label for="piano" name='li'>Simple Crafts</label>
                  <input type="checkbox" name='li' id='piano' class='checkbox'>
                </li>
          ...
          <div class="accordion-item">
            ...
            <div id="collapseNine" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
              <li>
                  <label for="com_club" name='li'>Identifying Emotions</label>
                  <input type="checkbox" name='li' id='com_club' class='checkbox'>
                </li>
              <li>
                  <label for="guitar" name='li'>Sharing and Taking Turns</label>
                  <input type="checkbox" name='li' id='guitar' class='checkbox'>
                </li>
              <li>
                  <label for="piano" name='li'>Family and Friends</label>
                  <input type="checkbox" name='li' id='piano' class='checkbox'>
                </li>
          ...
          <div class="accordion-item">
            ...
            <div id="collapseTen" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
              <div class="accordion-body">
              <li>
                  <label for="com_club" name='li'>Pattern Recognition</label>
                  <input type="checkbox" name='li' id='com_club' class='checkbox'>
                </li>
              <li>
                  <label for="guitar" name='li'>Completing Patterns</label>
                  <input type="checkbox" name='li' id='guitar' class='checkbox'>
                </li>
              <li>
                  <label for="piano" name='li'>Sequencing Events</label>
                  <input type="checkbox" name='li' id='piano' class='checkbox'>
                </li>
              <li>
                  <label for="piano" name='li'>Sorting Objects</label>
                  <input type="checkbox" name='li' id='piano' class='checkbox'>
                </li>
              <li>
                  <label for="piano" name='li'>Matching cards</label>
                  <input type="checkbox" name='li' id='piano' class='checkbox'>
                </li>
              <li>
                  <label for="piano" name='li'>Memory</label>
                  <input type="checkbox" name='li' id='piano' class='checkbox'>
                </li>
