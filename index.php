...
<html>
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Caprasimo&family=Concert+One&family=Mouse+Memoirs&display=swap" rel="stylesheet">
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link underline-li" href="#">Arts & Crafts</a>
        </li>
        <li class="nav-item">
          <a class="nav-link underline-li">Songs</a>
        </li>
        <li class="nav-item">
          <a class="nav-link underline-li">Expirements</a>
        </li>
        <li class="nav-item">
          <a class="nav-link underline-li">Books</a>
        </li>
